...
<a href="{{route('fee.exportwordsubfee',$id)}}" type="button" style="height:100px;width:200px;padding-top:35px;font-size:20px;margin-right:75px" class="btn btn-success">Xuất file word</a>
