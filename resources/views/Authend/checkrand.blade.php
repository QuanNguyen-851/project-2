            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        <form method="post" action="{{ route('checkrandprocess') }}"id="updatevalidateform">
                            @csrf
                            ...
                            <div class="card card-hidden">
                                ...
                                <div class="content">
                                    <div class="form-group">
                                        <label>Vui lòng nhập mã xác nhận đã được gửi đến mail  </label>
                                        <input type="text" name="rand" placeholder="Mã xác nhận" class="form-control"
                                        number="true"
                                        required
                                        >
                                    </div>
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-fill btn-warning btn-wd">xác nhận</button>
                                </div>
                            </div>
