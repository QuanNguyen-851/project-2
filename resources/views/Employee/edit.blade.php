...
<div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <span style="color:red">
                                @if (Session::has('errusername'))
                                {{Session::get('errusername')}}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" placeholder="City" value="{{$employee->phone}}"
                                required
                                minLength="9"
                                maxLength="10"
                                >
    ...
    <div class="col-md-4">
        <div class="card card-user">
            ...
            <div class="content">                
                     <a href="#">
                     <h4 class="title">{{$employee->userName}}<br />
                         <small>Họ và tên: {{$employee->name}}</small> 
                      </h4>
                    </a>
