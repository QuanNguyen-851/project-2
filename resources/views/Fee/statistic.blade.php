...
<div class="card" style=" margin-bottom: 5px;">
    <h2 style="margin-bottom: -5px;float: left;">Doanh thu </h2>
...
<div class="card">
    <div class="toolbar">
        ...
        <div class="dropdown">
            ...
            <button style="" class="btn dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
                @if($month==1)
                    Tháng {{$date -1}}
                @elseif($month==3)
                    3 tháng gần nhất
            ...
            <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ route('fee.statistic',['month'=>1])}}">Tháng {{$date-1}}</a></li>
             ...
             <a class="btn btn-warning" style="margin-right: 25px;margin-left: 5px;" href="{{ route('fee.exportstatistic', ['month'=>$month]) }}">Xuất danh sách</a>
        </div>
