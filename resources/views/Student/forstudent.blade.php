...
<div class="wrapper wrapper-full-page">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        ...
                        {{ route('checksearchForStudent') }} 
                        " id="updatevalidateform">
                            @csrf
                        <!--   if you want to have the card without animation please remove the ".card-hidden" class   -->
                            <div class="card card-hidden">
                                <div class="header text-center">Tra cứu lịch sử biên lai</div>
                                <div class="content">
                                    <div class="form-group">
                                        <label>Mã sinh viên</label>
                                        <input type="text" name="id" id="id" placeholder="Nhập mã sinh viên" class="form-control"
                                        required
                                        >
                                    </div>
                                    ...
                                    <a style="color:#888688;" >Ví dụ: BKC0123</a>
                                </div>
                                
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-fill btn-warning btn-wd">Tra cứu</button>
                                </div>
                            </div>
    ...
    <script>
        ...
        $('#id').change(function (e) { 
            var ma = $(this).val();
            var url = "http://127.0.0.1:8000/checking/"+ma;
            $.ajax({
                type: "get",
                url: url,
